...
import { MenuConsultasPage } from './../menu-consultas/menu-consultas';
...
export class MenuPrincipalPage {
  ...
  //Direcciona a la pagina Menu Consultas
  goToMenuConsultasPage() {
    this.navCtrl.push(MenuConsultasPage);
  }

  //Direcciona a la pagina configuracion
  goToMenuConfiguracionPage() {
