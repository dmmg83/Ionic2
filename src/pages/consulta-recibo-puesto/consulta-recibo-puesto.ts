...
/**
 * Generated class for the ConsultaReciboPuestoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-consulta-recibo-puesto',
  templateUrl: 'consulta-recibo-puesto.html',
})
export class ConsultaReciboPuestoPage {
  plazas;
  sectores;
  recibos;
  plazaSeleccionada;
  ...
  buscar() {
    ...
    this.databaseprovider.getAllRecibosPuestoFijo().then((datos)=>
    {
      this.recibos=datos;
    });
